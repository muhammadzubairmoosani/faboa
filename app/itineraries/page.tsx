...
import { Itineraries } from "../components/types";
import { itineraries } from "../utils/data.json";

import { useState } from "react";
import {
  ItinerariesFiltersAndSearch,
  Header,
  Sidebar,
  ItinerariesTable,
} from "../components";
...
export default function MembersPage() {
  ...
  const currentMembers: any = itineraries.slice(
    startIndex,
  ...
  const handleSelectAll = () => {
    if (selectedMembers.length === currentMembers.length) {
      ...
      setSelectedMembers(currentMembers.map((member: Itineraries) => member.id));
    }
  };
